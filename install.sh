...
# Install pip install -U git+https://github.com/NVIDIA/MinkowskiEngine -v --no-deps --install-option="--blas_include_dirs=$11.3/include" --install-option="--blas=openblas"
